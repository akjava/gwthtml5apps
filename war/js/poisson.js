...
(function() {
  ...
  var core = {
    ...
    load: function(srcImgName, dstImgName, maskImgName, onComplete, onError) {
      ...
      //possible img.src contain domain.//modified
      files[0]= images[0].src;
      files[1]= images[1].src;
      files[2]= images[2].src;
    ...
    set: function(srcImgData,dstImgData,maskImgData,resultData) {
       data[0]=srcImgData;
       data[1]=dstImgData;
       data[2]=maskImgData;
       data[3]=resultData;
    ...
    blend: function(iteration, offsetX, offsetY) {
      ...
      var w = data[0].width,
          ...
          step, l, m;
      // validation
      if(!(parseInt(iteration))) {
        throw TypeError('invalid parameter type iteration');
      }
      if(offsetX!=0 && !(parseInt(offsetX))) {
          throw TypeError('invalid parameter type x');
        }
      if(offsetY!=0 && !(parseInt(offsetY))) {
          throw TypeError('invalid parameter type y');
        }
      // core operation
